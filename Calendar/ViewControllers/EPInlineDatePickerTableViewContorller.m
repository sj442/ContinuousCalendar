...
//    if (!self.contact) {
//        cell.textLabel.text = EPInlineDatePickerTableViewControllerContactPlaceHolderString;
//        self.contactPlaceHolder = YES;
//        cell.textLabel.textColor = [UIColor colorWithWhite:0.8 alpha:1];
//    } else {
//        self.contactPlaceHolder = NO;
//        cell.textLabel.text = self.contact.fullName;
//        cell.textLabel.textColor = [UIColor blackColor];
//    }
//    
//    if (self.contact && self.editMode) {
//    UIButton *closeButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width-30, 10, 30, 30)];
//    [closeButton setImage:[UIImage imageNamed:@"B_taskbar_close-icon-outline"] forState:UIControlStateNormal];
//    [closeButton addTarget:self action:@selector(removeContactButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
...
//        EPContactListTableViewController *vc = [[EPContactListTableViewController alloc] initWithSelectionBlock:^(id contact) {
//            [self contactToBePassed:contact];
...
//- (void)contactToBePassed:(Contact *)contact
//{
//    self.contact = contact;
//    [self.tableView reloadData];
//}

//- (void)removeContactButtonPressed:(id)sender
//{
//    if (self.contact) {
//        self.contact = nil;
//        [self.tableView reloadData];
